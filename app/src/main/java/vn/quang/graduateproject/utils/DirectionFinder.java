...
public class DirectionFinder {
    ...
    private IDirectionFinder listener;
    private LatLng origin;
    private LatLng destination;
    private String mode;

    public DirectionFinder(IDirectionFinder listener, LatLng origin, LatLng destination, String mode) {
    ...
    private String createUrl() throws UnsupportedEncodingException {
        return DIRECTION_URL_API + "origin=" + origin.latitude + "," + origin.longitude + "&destination="
