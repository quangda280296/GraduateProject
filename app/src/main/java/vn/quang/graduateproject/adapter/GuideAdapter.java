...
public class GuideAdapter extends RecyclerView.Adapter<GuideAdapter.RecyclerViewHolder> {
    ...
    public GuideAdapter(Context context, Route route, GoogleMap mMap, List<String> list, BottomSheetBehavior mBottomSheetBehavior, List<Marker> marker, NestedScrollView scrollView) {
